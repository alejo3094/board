...
SECRET_KEY = 'q84(6a@9h8ix@5)go188cg+p5%0n*ily*6c^wk9@l2ci&zghg%'
...
INSTALLED_APPS = [
    ...
    'applications.board.apps.BoardConfig',
    'applications.note.apps.NoteConfig',
    'applications.noteRequest.apps.NoterequestConfig',
]
